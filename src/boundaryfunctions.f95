...
!
!>    This module contains functionality necessary to find boundary faces in a
!!    Gmesh file. It is completely self contained
!
...
CONTAINS
    ...
    SUBROUTINE findboundaries(faces,numel,boundfaces,totbound,numproc)
        ...
        DO i=1,numel
            ...
            END DO
        END DO
        WRITE(*,'(2(I0,A))',ADVANCE='NO')totbound,' boundary faces, ',4*numel,' faces total'
    ...
    SUBROUTINE getfaces(faces,elements,numelements,numproc)
        ...
        INTEGER,INTENT(IN)::numproc
        !> Info on elements
        INTEGER,INTENT(IN)::elements(numelements,9)
